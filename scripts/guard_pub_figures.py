...
def fig7(out):
    ...
    ax.axis("off")
    ax.set_title("M. tuberculosis H37Rv  —  GUARD target loci",
...
def generate_all_figures(out_dir, cands=None):
    ...
    print("═" * 60)
    print("  GUARD Publication Figure Suite  (Figs 1–11)")
...
def main():
    ap = argparse.ArgumentParser(description="GUARD Publication Figure Suite")
