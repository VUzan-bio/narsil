...
_POSITION_SENSITIVITY_AsCas12a = {
    # Revised to match Kim et al. 2017, Strohkendl et al. 2018 data.
    # Seed positions 1-5 are near-catastrophic for R-loop propagation.
    1: 0.99, 2: 0.98, 3: 0.96, 4: 0.94, 5: 0.90,
    6: 0.85, 7: 0.78, 8: 0.70,  # seed boundary
    9: 0.55, 10: 0.48, 11: 0.42, 12: 0.36,
    13: 0.30, 14: 0.25,  # trunk
    15: 0.20, 16: 0.16, 17: 0.13, 18: 0.10,
    19: 0.08, 20: 0.06, 21: 0.05, 22: 0.04, 23: 0.03,  # tail
}
...
_POSITION_SENSITIVITY_enAsCas12a = {
    # enAsCas12a: engineered for broader PAM but seed specificity
    # remains very high. Kleinstiver et al. 2019 shows positions 1-5
    # are near-catastrophic even for tolerable mismatch types.
    1: 0.98, 2: 0.97, 3: 0.95, 4: 0.92, 5: 0.88,
    6: 0.82, 7: 0.75, 8: 0.68,
    9: 0.52, 10: 0.45, 11: 0.38, 12: 0.32,
    13: 0.27, 14: 0.22,
    15: 0.17, 16: 0.14, 17: 0.11, 18: 0.08,
    19: 0.06, 20: 0.05, 21: 0.04, 22: 0.03, 23: 0.03,
}
...
def _generate_synthetic_sites(
    ...
    for pos in range(search_start, search_end + 1):
        ...
        original_rna = _rna_base_for_dna(
            ...
            #
            # Since spacer_seq == MUT_target (by GUARD convention):
...
def enhance_candidate_batch(
    ...
    This is the batch interface for integration with the GUARD pipeline.
    """
    if config is None:
        config = EnhancementConfig()
...
def enhance_from_scored_candidates(
    ...
    """Integration point for the GUARD pipeline.
