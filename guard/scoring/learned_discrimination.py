...
from guard.scoring.discrimination import (
...
# Ensure guard-net is importable
...
_GUARD_NET_DATA = _GUARD_NET_DIR / "data"
if str(_GUARD_NET_DATA) not in sys.path:
    sys.path.insert(0, str(_GUARD_NET_DATA))
...
class LearnedDiscriminationScorer(Scorer):
    ...
    Usage:
        scorer = LearnedDiscriminationScorer(
            model_path="guard-net/checkpoints/disc_xgb.pkl",
    ...
    def __init__(
        ...
        if model_path is None:
            ...
            model_path = _GUARD_NET_DIR / "checkpoints" / "disc_xgb.pkl"
